...
When `completion_count = 1` and the number of cqes in uring matches, timeout sqe completes with '0' - success.
...
val res : int = 0
# let timeout_job, res = consume t;;
val timeout_job : job = Timeout
val res : int = 0
# Uring.exit t;;
- : unit = ()
```

When `completion_count = 0`, timeout always returns -ETIME/-62.
...
# let ns1 = Int64.(mul 10L 1_000_000L);;
val ns1 : int64 = 10000000L
# let timeout_job = Uring.(timeout ~completion_count:0 t Boottime ns1 Timeout);;
val timeout_job : job Uring.job option = Some <abstr>
# Uring.submit t;;
- : int = 2
# let completed_job, res = consume t;;
...
When `completion_count = 2` is not matched, then timeout job returns with -ETIME/-62.
...
# let ns1 = Int64.(mul 10L 1_000_000L);;
val ns1 : int64 = 10000000L
# let timeout_job = Uring.(timeout ~completion_count:2 t Boottime ns1 Timeout);;
val timeout_job : job Uring.job option = Some <abstr>
# Uring.submit t;;
- : int = 2
# let completed_job, res = consume t;;
